...
원본 데이터를 담고 있는 엑셀파일*[[내려받기](/asset/excel/패널자료_2010_2019. 코스피코스닥.xlsx)]*은 다음과 같다. 코스피와 코스닥에 상장된 기업들의 과거 10년간의 매출액, 영업이익, 당기순이익과 섹터 정보를 담은 자료이다. 총 22,600개의 행(row)과 7개의 열(column)로 구성돼있다.
